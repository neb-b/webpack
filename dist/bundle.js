...
function portals() {
  ...
  var portals = document.querySelector('portal');
  var blue = document.querySelector('.blue');
  var orange = document.querySelector('.orange');

  blue.addEventListener('mousedown', function () {
    return togglePortalMovement('movingBluePortal');
  });
  orange.addEventListener('mousedown', function () {
    return togglePortalMovement('movingOrangePortal');
  });
  ...
  function updateState(direction, val) {
    var newMargin = state.location[direction] + val;
